...
public:
	...
	static void setDefaultElementSpacing(int elementspacing);
	static void setDefaultElementIndentation(float indentation);
...
protected:
	...
	static int defaultElementSpacing;
	static float defaultElementIndentation;
