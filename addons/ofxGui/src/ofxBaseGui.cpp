...
void ofxGuiSetDefaultSpacing(int spacing){
	ofxBaseGui::setDefaultSpacing(spacing);
}

void ofxGuiSetDefaultElementSpacing(int elementspacing){
	ofxBaseGui::setDefaultElementSpacing(elementspacing);
}
...
int ofxBaseGui::defaultSpacing = 1;
int ofxBaseGui::defaultElementSpacing = 3;
float ofxBaseGui::defaultElementIndentation = 0.98;
...
void ofxBaseGui::draw(bool framebufferedMode){
...
void ofxBaseGui::setDefaultSpacing(int spacing){
	defaultSpacing = spacing;
}

void ofxBaseGui::setDefaultElementSpacing(int elementspacing){
	defaultElementSpacing = elementspacing;
}

void ofxBaseGui::setDefaultElementIndentation(float indentation) {
	defaultElementIndentation = indentation;
}
